...
public class FqVariable {
    ...
    private void initializeFromConfig(FQApiProperties.Device device) {
        ...
        this.language = "zh";
        this.osApi = device.getOsApi() != null && !device.getOsApi().trim().isEmpty() ? device.getOsApi() : "32";
        this.osVersion = device.getOsVersion() != null && !device.getOsVersion().trim().isEmpty() ? device.getOsVersion() : "13";
